...
//        return result;
    ...
    public Collection<MusicItem> findSelfTitled() {
        Collection<MusicItem> result = new ArrayList<>();
        for (MusicItem item : catalogData) {
            if (item.getArtist().equalsIgnoreCase(item.getTitle())) {
                result.add(item);
            }
        }
        return result;
     ...
     */
    public Collection<MusicItem> findCheapestInGenre () {
        Collection<MusicItem> result = new ArrayList<> ();
     ...
     */
    public Collection<MusicItem> findAverageInGenre () {
        Collection<MusicItem> result = new ArrayList<> ();
     ...
     */
    public boolean genreInStock (MusicCategory category) {
        boolean result = false;
     ...
     * Just the titles!
     */
    public Collection<MusicItem> findAllPop () {
        Collection<MusicItem> result = new ArrayList<> ();
     ...
     */
    public Collection<MusicItem> findCheapEighties () {
        Collection<MusicItem> result = new ArrayList<>();
